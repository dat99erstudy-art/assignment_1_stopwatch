...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, CS_I2C_SPI_Pin|LED_Moto_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OTG_FS_PowerSwitchOn_GPIO_Port, OTG_FS_PowerSwitchOn_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, LED_SignalLeft_Pin|LED_SignalRight_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CS_I2C_SPI_Pin LED_Moto_Pin */
  GPIO_InitStruct.Pin = CS_I2C_SPI_Pin|LED_Moto_Pin;
  ...
  /*Configure GPIO pins : OTG_FS_PowerSwitchOn_Pin LED_SignalLeft_Pin LED_SignalRight_Pin */
  GPIO_InitStruct.Pin = OTG_FS_PowerSwitchOn_Pin|LED_SignalLeft_Pin|LED_SignalRight_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BTN_TurnLeft_Pin BTN_TurnRight_Pin BTN_Hazard_Pin */
  GPIO_InitStruct.Pin = BTN_TurnLeft_Pin|BTN_TurnRight_Pin|BTN_Hazard_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : BTN_WiperMode_Pin */
  GPIO_InitStruct.Pin = BTN_WiperMode_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BTN_WiperMode_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : LD4_Pin LD3_Pin LD5_Pin LD6_Pin
                           Signal_Left_Pin Signal_Right_Pin Audio_RST_Pin */
